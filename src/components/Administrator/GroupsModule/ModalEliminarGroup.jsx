...
const ModalEliminarGroup = ({ id, prefijo }) => {
  ...
  const eliminar = async (id) => {
    try {
      ...
      //recarga los grupos en el contexto
      reloadGrupos();
    } catch (error) {
      toast.error("Error al intentar eliminar grupo!");
    }
  };

  return (
    <>
      <Tooltip content="Eliminar grupo" placement="right" style="light">
...
export default ModalEliminarGroup;
