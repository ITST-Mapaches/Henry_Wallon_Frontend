    ...
    return (
        <>
            ...
            <td className="p-4 rounded-s-2xl text-left">
                ...
                <span className="rounded-full h-12 w-12 shadow-sm shadow-white text-primary bg-white flex items-center justify-center font-bold text-lg">{id}</span>
                <div className="ml-3">
            ...
            <td className="p-4 h-full flex items-center justify-start">
                <span className="relative flex h-3 w-3">
                    <span className={`animate-ping  absolute inline-flex h-full w-full rounded-full opacity-75 ${activo == 1 ? 'bg-lime-300' : 'bg-rose-500'}`}></span>
                    <span className={`relative inline-flex rounded-full h-3 w-3 ${activo == 1 ? 'bg-lime-300' : 'bg-rose-500'}`}></span>
                </span>
                <br />
                <br />
            ...
            <td className="p-4">
                <span className={`${background[rol]} text-gray-50 rounded-md px-2 font-semibold`}>
                {rol}
                </span>
            </td>
