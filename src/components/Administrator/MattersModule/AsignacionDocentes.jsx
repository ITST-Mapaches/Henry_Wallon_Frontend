        ...
        <Modal.Body>
          <div className="space-y-6">
            ...
            <p>
              ...
              <br />
              <span className="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-red-600 relative block w-fit mx-auto mt-4">
                  ...
                  {grupos.map((grupo) => (
                    <div className="mb-6" key={grupo.id}>
                      <div className="mb-2 block">
                        <Label
                          htmlFor={grupo.id}
                          value={`Docente para grupo: ${grupo.prefijo}`}
                        />
                      </div>
                      ...
                      >
                        ...
                        {docentes.map((docente) => (
                          <option id={docente.id} key={docente.id} value={docente.id}>
                            {docente.id + " - " + docente.name}
                          </option>
                        ))}
                      </Select>
                    </div>
