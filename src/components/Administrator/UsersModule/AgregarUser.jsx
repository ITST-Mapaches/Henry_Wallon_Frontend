                ...
                <div className="flex gap-4">
                  ...
                  <div className="basis-6/12 flex flex-col gap-4" >
                    ...
                    <div>
                      ...
                      <TextInput type="password" name="contrasena" id="contrasena" value={contrasena} onChange={onInputChange} placeholder="Ingresa la contraseña" minLength={5} maxLength={20} required  addon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
