        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <h3 className="mb-5 text-lg font-bold text-primary">
              ¿Estás seguro de que quieres eliminar el siguiente periodo
              escolar?
              <br />
              <span className="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-red-600 relative inline-block">
                <span className="relative text-white"> periodo: {numero}</span>
              </span>
            </h3>
            <div className="flex justify-center gap-4">
              <Button color="" className="bg-red-600 font-semibold text-white hover:scale-105 active:scale-95 hover:bg-red-700" onClick={() => {
                  setOpenModal(false);
                  eliminar(id);
                }}>
                Sí, estoy seguro
