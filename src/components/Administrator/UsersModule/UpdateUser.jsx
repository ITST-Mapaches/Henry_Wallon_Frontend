...
const UpdateUser = ({ user, inputRole, rol, setOpenModal }) => {
  ...
  const {
    ...
    id_usuario_tutor: user.id_usuario_tutor,
    id_periodo: user.id_periodo,
    id_grupo: user.id_grupo,
    cedula_prof: user.cedula_prof,
  });
  ...
  return (
    <>
      <form onSubmit={onSubmit}>
          ...
          <div className="basis-6/12 flex flex-col gap-4">
            ...
            {(inputRole.Alumno && (
              <>
                ...
                <div>
                  ...
                  <Select
                    id="id_usuario_tutor"
                    name="id_usuario_tutor"
                    value={id_usuario_tutor}
                    onChange={onInputChange}
                    disabled={bloquearEdit}
                    required
                    addon={
            ...
            <div>
              <div className="mb-2 mt-4 block text-center">
                <Label
                  htmlFor="activo"
                  value={`Cuenta activa: ${(active && "Sí") || "No"}`}
                />
                <ToggleSwitch
                  color="blue"
                  className="mx-auto"
        ...
        <button
          type="button"
          className="text-gray-400 hover:text-gray-100 mt-4 hover:scale-1 absolute bottom-4 right-4"
          onClick={() => {
            setBloquearEdit(!bloquearEdit);
          }}
        ...
        {(!bloquearEdit && (
          <Button
            type="submit"
            className="active:scale-95 mt-4 px-2 bg-sky-600 mx-auto font-bold"
          >
            Actualizar
          </Button>
        )) ||
