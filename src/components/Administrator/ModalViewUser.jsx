...
const ModalInformation = ({ user, inputRole, rol, setOpenModal }) => {
  ...
  const {
    form, nombre, ap_paterno, ap_materno, nacimiento, telefono, nombre_usuario, contrasena, activo, id_sexo, id_rol, num_control, id_usuario_tutor, id_periodo, id_grupo, cedula_prof, onInputChange, onResetForm,
  ...
  const { data: tutores, isLoading: isLoadingTutores } = useFetch("getUsuarios/tutores");
  ...
  return (
    <>
      <form onSubmit={onSubmit}>
        ...
        <div className="flex gap-4">
          ...
          <div className="basis-6/12 flex flex-col gap-4">
            ...
            <div>
              ...
              <TextInput type="tel" id="telefono" name="telefono" value={telefono} onChange={onInputChange} placeholder="Ingresa el número telefónico" maxLength={12} disabled={bloquearEdit} required addon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
            ...
            <div>
              ...
              <TextInput type="password" name="contrasena" id="contrasena" value={contrasena} onChange={onInputChange} placeholder="Ingresa la contraseña" maxLength={12} max={12} disabled={bloquearEdit} required addon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
          ...
          <div className="basis-6/12 flex flex-col gap-4">
            ...
            <div>
              ...
              <Select id="id_sexo" name="id_sexo" value={id_sexo} onChange={onInputChange} disabled={bloquearEdit} required addon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
            ...
            <div>
              ...
              <Select id="id_rol" name="id_rol" value={id_rol} disabled required addon={
                ...
                <option value="loading" key={new Date().getDate()}>{rol}</option>
              </Select>
            </div>
            {/* input rol */}
            {(inputRole.Alumno && (
              <>
                ...
                <div>
                  ...
                  <TextInput name="num_control" id="num_control" value={num_control} onChange={onInputChange} placeholder="Ingresa el número de control" maxLength={15} disabled={bloquearEdit} required addon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                ...
                <div>
                  ...
                  <Select id="id_usuario_tutor" name="id_usuario_tutor" value={id_usuario_tutor} onChange={onInputChange} disabled={bloquearEdit} required  addon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                ...
                <div>
                  ...
                  <Select id="id_periodo" name="id_periodo" value={id_periodo} onChange={onInputChange} disabled={bloquearEdit} required addon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-6h.008v.008H12v-.008ZM12 15h.008v.008H12V15Zm0 2.25h.008v.008H12v-.008ZM9.75 15h.008v.008H9.75V15Zm0 2.25h.008v.008H9.75v-.008ZM7.5 15h.008v.008H7.5V15Zm0 2.25h.008v.008H7.5v-.008Zm6.75-4.5h.008v.008h-.008v-.008Zm0 2.25h.008v.008h-.008V15Zm0 2.25h.008v.008h-.008v-.008Zm2.25-4.5h.008v.008H16.5v-.008Zm0 2.25h.008v.008H16.5V15Z" />
                     </svg>}>
                    <option value="" key={new Date().getDate()}>Selecciona una opción</option>
              ...
              (inputRole.Docente && (
                ...
                <div>
                  ...
                  <TextInput name="cedula_prof" id="cedula_prof" value={cedula_prof} onChange={onInputChange} placeholder="Ingresa la cédula profesional" maxLength={20} disabled={bloquearEdit} required addon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z" />
                  </svg>} />
                </div>
              ))}
        ...
        {(!bloquearEdit && (<Button type="submit" className="active:scale-95 mt-4 px-2 bg-sky-600 mx-auto font-bold">Actualizar</Button>)) || ""}
      ...
      <Modal show={openModal} size="4xl" className="bg-primary" popup>
        ...
        <Modal.Body>
          <div className="space-y-6">
            <h3 className="text-xl font-medium text-gray-900">Información usuario - {id}</h3>

            {(isLoading && <Loader />) || ( <ModalInformation user={user} inputRole={inputRole} rol={rol} setOpenModal={setOpenModal}/> )}
